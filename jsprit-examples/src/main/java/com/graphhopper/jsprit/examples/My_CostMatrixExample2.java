...
public class My_CostMatrixExample2 {
    ...
    public static void main(String[] args) {
        ...
        VehicleType type1 = VehicleTypeImpl.Builder.newInstance("type1").addCapacityDimension(0, 5).addCapacityDimension(1, 50)
            .setCostPerDistance(1).setCostPerServiceTime(0).setFixedCost(0).setCostPerTransportTime(1)
            .build();
        ...
        VehicleImpl vehicle1 = VehicleImpl.Builder.newInstance("1")
            ...
            //.setEndLocation(Location.newInstance("3"))
            .setType(type1).build(),
...
//            .setPickupServiceTime(1).setDeliveryServiceTime(1)
//            .build();
        Shipment s3 = Shipment.Builder.newInstance("s3").addSizeDimension(0,1).addSizeDimension(1, 2)
...
/*        costMatrixBuilder.addTransportDistance("0", "1", 0.0);
        ...
        costMatrixBuilder.addTransportDistance("0", "1", 1.0);
        costMatrixBuilder.addTransportDistance("0", "2", 3.0);
        costMatrixBuilder.addTransportDistance("0", "3", 100.0);
        costMatrixBuilder.addTransportDistance("0", "4", 1.0);

        costMatrixBuilder.addTransportDistance("1", "2", 1.0);
        costMatrixBuilder.addTransportDistance("1", "3", 10.0);
        costMatrixBuilder.addTransportDistance("1", "4", 100.0);

        costMatrixBuilder.addTransportDistance("2", "3", 1.0);
        costMatrixBuilder.addTransportDistance("2", "4", 100.0);

        costMatrixBuilder.addTransportDistance("3", "4", 1.0);
        ...
        costMatrixBuilder.addTransportTime("0", "4", 1.0);
        ...
        costMatrixBuilder.addTransportTime("3", "4", 1.0);
