...
public class BreakExample {
    ...
    public static void main(String[] args) {
        ...
        VehicleImpl v1 = vehicleBuilder.build();
		 ...
		 */
        Service service1 = Service.Builder.newInstance("s1").addSizeDimension(WEIGHT_INDEX, 1).setServiceTime(10).setLocation(Location.newInstance(5, 7)).build();
        Service service2 = Service.Builder.newInstance("s2").addSizeDimension(WEIGHT_INDEX, 1).setLocation(Location.newInstance(5, 13)).build();

        Service service3 = Service.Builder.newInstance("s3").addSizeDimension(WEIGHT_INDEX, 1).setLocation(Location.newInstance(15, 7)).build();
        Service service4 = Service.Builder.newInstance("s4").addSizeDimension(WEIGHT_INDEX, 1).setLocation(Location.newInstance(15, 13)).build();
